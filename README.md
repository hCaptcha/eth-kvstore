...
`KVSTORE_ADDRESS` is the location where KVStore has been deployed. Current location of our Ropsten testnet deployment is in the following address: `0x03b46fc66a665665ccf1f5a5db63d953cb70bd85`. You can also deploy your own KVStore by following the `Deployment` section of the guide.
